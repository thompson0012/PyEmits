# disclaimer: this module is the collection of some time-series aggregation for feature engineering by LUCAS MORIN
...
# So feature engineering becomes having and choosing features to build from groups.
# Below is a set of functions that are usefull for time series aggregations.
...
higher_order_stats = [abs_energy, root_mean_square, sum_values, realized_volatility, realized_abs_skew, realized_skew,
                      realized_vol_skew, realized_quarticity]
